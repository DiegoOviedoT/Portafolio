...
const observer = new IntersectionObserver((entries)=>{
  entries.forEach((entry)=>{
    ...
    if(entry.isIntersecting){
      document.querySelector(".navbar__menu--link--icon.active").classList.remove('active');
      document.querySelector(".navbar__menu--link--text.active").classList.remove('active');
